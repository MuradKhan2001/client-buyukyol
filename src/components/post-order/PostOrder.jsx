    ...
    const getAddressLocation = () => {
        ...
        if (locationFrom) {
            if (searchLocationAddress && selected) {
                ...
                let idAlert = Date.now()
                let alert = {
                    id: idAlert, text: t("alert7"), img: "./images/yellow.svg", color: "#FFFAEA"
                }
                dispatch(addAlert(alert))
                setTimeout(() => {
                    dispatch(delAlert(idAlert))
    ...
    return <div className="post-order-container">
        ...
        >
            <div className={`modal-sloy ${modalShow.status === "order" ? "align-none" : ""}`}>
                ...
                {modalShow.status !== "getLocation" && <div ref={nodeRef} className="modal-card">

                    {modalShow.status === "payment-type" && <div className="form-orders">
                    ...
                    {modalShow.status === "cargo-weight" && <div className="form-orders">
                        <div className="cancel-btn">
                            <img onClick={() => showModalForm("", false)} src="./images/x.png" alt=""/>
                        </div>
                    ...
                    {modalShow.status === "weight-type" && <div className="form-orders">
                        <div className="cancel-btn">
                            <img onClick={() => showModalForm("", false)} src="./images/x.png" alt=""/>
                        </div>
                    ...
                    {modalShow.status === "order" && <div className="show-order">
                        <div className="cancel-btn">
                            <img onClick={() => showModalForm("", false)} src="./images/x.png" alt=""/>
                        </div>
            ...
            <div className="form-informations">
                ...
                <div className="left-forms">
                    ...
                    <div onClick={() => {
                        ...
                        if (cargo.latitude_from && cargo.longitude_from) {
                            let locMy = {lat: cargo.latitude_from, lng: cargo.longitude_from}
                            setCenter(locMy)
                        }
                    }} className="form-box">
                        ...
                        <div onClick={() => {
                            if (locationFromAddress) {
                                ...
                                if (cargo.latitude_to && cargo.longitude_to) {
                                    let locMy = {lat: cargo.latitude_to, lng: cargo.longitude_to}
                                    setCenter(locMy)
                                }
                            } else {
                                let idAlert = Date.now();
                                let alert = {
                                    id: idAlert, text: t("errorLocations2"), img: "./images/red.svg", color: "#FFEDF1"
                                };
                                dispatch(addAlert(alert));
                                errorAudio()
                                setTimeout(() => {
                    ...
                    {direction === "Abroad" && distance && <div className="distance">
                ...
                <div className="right-forms">
                    ...
                    <div className="form-box-radio">
                        ...
                        {formik.errors.capacity && formik.errors.capacity !== "Required" ? <div className="error">
                    ...
                    {direction !== "Abroad" && countryCode !== "uz" && countryCode !== "" &&
                        < div className="form-box-radio">
                            <label htmlFor="cargo">{t("info8")}</label>
                            ...
                            <div
                                ...
                                <div onClick={() => !negotiable ? showModalForm("currency", true) : ""}
            ...
            {plusInformation ? <div className="plus-information-forms">
                ...
                <div className="content-forms">
                    <div className="form-box">
                        ...
                        {formik.errors.number_cars && formik.errors.number_cars !== "Required" ? <div className="error">
                ...
                <div className="content-forms">
                    {direction === "Abroad" && <div className="form-box-radio">
                        ...
                        {formik.errors.avans && formik.errors.avans !== "Required" ? <div className="error">
                            {formik.errors.avans}
                        </div> : ""}
                    ...
                    {direction === "Abroad" && <div className="form-box-radio">
                        ...
                        {formik.errors.wait_cost && formik.errors.wait_cost !== "Required" ? <div className="error">
